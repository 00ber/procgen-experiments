...
if __name__ == "__main__":
    ...
    # env setup
    envs = ProcgenEnv(num_envs=args.num_envs, env_name=args.env_id, num_levels=0, start_level=0, distribution_mode="easy", render_mode="rgb_array")
    ...
    for phase in range(1, num_phases + 1):
        ...
        model_path = f"./models/ppg-agent.pt"
