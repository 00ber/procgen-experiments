...
envs.ob_space = envs.observation_space
envs.ac_space = envs.action_space
envs.num = 1
reset = envs.reset
step = envs.step
...
envs.single_action_space = envs.ac_space
envs.single_observation_space = envs.ob_space["rgb"]
...
next_obs = envs.reset()
# print(dir(envs))
# next_obs = envs.callmethod("get_state")
